  ...
  return (
    <>
      <section 
        ...
        aria-label="Page d'accueil - Digital Service Technologie"
      >
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
        <div 
          ...
          role="img"
          aria-label="Arrière-plan technologique"
        />
        ...
        <header className="animate-fadeInUp">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 sm:mb-12 px-4">
            <button 
              ...
              aria-label="Contactez-nous maintenant pour discuter de votre projet"
            >
          ...
          {/* Stats */}
          <section className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-2xl mx-auto px-4" aria-label="Nos statistiques">
            <article className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2" aria-label="Plus de 50 projets réalisés">50+</div>
              <div className="text-sm sm:text-base text-gray-300">Projets Réalisés</div>
            </article>
            <article className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2" aria-label="98% de clients satisfaits">98%</div>
              <div className="text-sm sm:text-base text-gray-300">Clients Satisfaits</div>
            </article>
            <article className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2" aria-label="Plus de 3 années d'expérience">3+</div>

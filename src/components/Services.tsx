...
const Services = () => {
  ...
  return (
    <section id="services" className="py-12 sm:py-16 lg:py-20 bg-white" aria-labelledby="services-title">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-12 sm:mb-16">
          <h2 id="services-title" className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Nos Services
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8" role="list" aria-label="Liste de nos services">
            ...
            return (
              ...
              >
                <div className="bg-gradient-to-r from-blue-500 to-purple-500 w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <IconComponent className="h-7 w-7 sm:h-8 sm:w-8 text-white" aria-hidden="true" />
                </div>
                ...
                <ul className="space-y-2" role="list" aria-label={`Fonctionnalités de ${service.title}`}>
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center text-xs sm:text-sm text-gray-500" role="listitem">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mr-2 sm:mr-3 flex-shrink-0" aria-hidden="true" />
                ...
                <button 
                  className="mt-4 sm:mt-6 text-blue-600 font-semibold hover:text-purple-600 transition-colors duration-300 flex items-center group text-sm sm:text-base"
